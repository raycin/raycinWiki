...
//        username = normalize(username);
     ...
     * <li><b>protection</b>: (Map) the {@link #protect(String,
     * Map, String) protection state} of the page. Does
...
//        String url = query + "action=query&generator=allpages&prop=revisions&rvprop=content&titles=" + page;
        String offset = "";
        List<String> pages = new ArrayList<>(1333);
     ...
     * @throws IOException if a network error occurs
     * @see #multipartPost(String, Map, String)
     * @since 0.24
     */
